...
def _normalize_torrent(raw_torrent):
    ...
    # Prowlarr's 'hash' field can be null in search results. Fallback to 'id'.
    # This ensures we always have a unique identifier for actions like 'ignore'.
    unique_id = raw_torrent.get('hash') or str(raw_torrent.get('id'))
