...
from app.utils.prowlarr_client import get_latest_from_prowlarr, get_prowlarr_categories
...
@dashboard_bp.route('/dashboard/categories')
def list_categories():
    """
    Page to display all available Prowlarr categories to help with configuration.
    """
    categories = get_prowlarr_categories()
    return render_template('dashboard/categories.html', categories=categories, title="Catégories Prowlarr")
