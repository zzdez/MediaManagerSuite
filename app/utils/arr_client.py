        ...
        if candidate.get('id') and candidate.get('id') > 0:
            ...
            if title_in_sonarr == title_to_search.lower():
                if year_to_search and candidate.get('year') == year_to_search:
                    return candidate # Correspondance parfaite avec année
                elif not year_to_search:
                    return candidate # Première correspondance de titre si pas d'année
...
def find_radarr_movie_by_release_name(release_name):
    ...
    for candidate in candidates:
        ...
        if year_to_search and candidate_year and year_to_search == candidate_year:
