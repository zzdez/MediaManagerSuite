    ...
    try:
        ...
        if options.get('archive'):
            try:
                ...
                current_app.logger.error(f"Erreur majeure lors de la sauvegarde manuelle dans la BDD d'archives pour '{movie.title}': {e}", exc_info=True)
        ...
        if options.get('archive'):
            try:
                ...
                success, message = add_archived_media(
                    ...
                    external_id=tvdb_id,
                    user_id=user_id,
                    # On passe les données additionnelles pour l'archivage manuel
                    title=show.title,
                    year=show.year,
